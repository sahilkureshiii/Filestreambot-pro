...
class Var(object):
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', 'mongodb+srv://sahilkureshi8117:SMARTY786skyt@cluster0.iacbhvy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'))
